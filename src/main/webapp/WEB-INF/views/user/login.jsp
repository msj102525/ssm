...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="resources/css/user/login.css?ver2">
</head>
<body>
	<div class="login-box">
		<div class="inner-box">
			...
			<div class="form-box">
				<form action="login.do" method="post">
					<ul>
						...
						<li>
							<c:url var="#" value="#" />
							<a href=#> <img src="/ssm/resources/images/naverLB.png" alt="logo" /></a>
						</li>
						<li>
							<c:url var="#" value="#" />
							<a href=#> <img src="/ssm/resources/images/googleLB.png" alt="logo" /></a>
						</li>
					</ul>
				</form>
			</div>
