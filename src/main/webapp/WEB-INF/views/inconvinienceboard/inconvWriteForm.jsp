...
<body>
    ...
    <div class="container">
        ...
        <form id="writeForm" action="iwrite.do" method="POST">
            <input type="text" name="boardTitle" maxlength="44" class="title-input" placeholder="제목을 입력해주세요 최대 44글자" required>
            <hr>
            <textarea name="boardContent" class="contentbox" rows="20" cols="20" maxlength="254" placeholder="내용을 입력해주세요 최대 254글자" required></textarea>
            <hr>
