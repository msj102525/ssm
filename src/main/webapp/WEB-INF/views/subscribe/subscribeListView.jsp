		...
		<div id="payment-method">
			...
			<div class="payment-section" id="card-payment">
				...
				<img src="resources/images/paylogo/danal.png"
					...
					data-payment-method="kginicis">
					 <img
					src="resources/images/paylogo/tosspayments.png"
					data-payment-method="uplus">
			</div>
		</div>
		<br>
		<hr>
		...
		<div id="agreement"
			...
			<div class="payment-option" id="payment-option-1"
				...
				<p class="agreeDetail" id="detail-1" style="display: none;">①
					회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은 즉시 회원탈퇴를 처리합니다. ② 회원이 다음 각 호의 사유에
					해당하는 경우, “몰”은 회원자격을 제한 및 정지시킬 수 있습니다. 1. 가입 신청 시에 허위 내용을 등록한 경우 2.
			...
			<div class="payment-option" id="payment-option-2"
				...
				<p class="agreeDetail" id="detail-2" style="display: none;">①
					...
					동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) ③ “몰”이 제3자에게 구매자의 개인정보를
			...
			<div class="payment-option" id="payment-option-3">
				...
				<p class="agreeDetail" id="detail-3" style="display: none;">①
					“몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에
