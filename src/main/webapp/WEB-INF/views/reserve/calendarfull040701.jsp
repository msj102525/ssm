...
/* Icons */
#name {
  /* background-image: url(http://rexkirby.com/kirbyandson/images/name.svg); */ /* 이미지 없음(2024.04.07) */ 
...
#email {
  /* background-image: url(http://rexkirby.com/kirbyandson/images/email.svg); */ /* 이미지 없음(2024.04.07) */
  background-size: 30px 30px;
  background-position: 11px 8px;
  background-repeat: no-repeat;
}
...
#comment {
	/* background-image: url(http://rexkirby.com/kirbyandson/images/comment.svg); */ /* 이미지 없음(2024.04.07) */
	background-size: 30px 30px;
	background-position: 11px 8px;
	background-repeat: no-repeat;
}
