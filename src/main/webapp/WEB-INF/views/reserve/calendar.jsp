...
<script type="text/javascript" src="${ path }/resources/js/reserve/reserveboard.js"></script>
<script type="text/javascript" src="${ path }/resources/js/jscolor.min.js"></script>
...
.normal_move_board_modal {
	...
	background-colr: white !important;
}
...
<body>
	...
	<form name="calendarFrm" id="calendarFrm" action="" method="GET">
		<input type="text" name="year" value="${ today_info.search_year }" />
		<input type="text" name="month" value="${ today_info.search_month - 1 }" />
		<script>
			/* 스케쥴 등록시 등록완료 팝업창 */
			var message = "${ message }";
			console.log(message);
		...
		<div class="calendar">
			...
			<div class="navigation">
				...
				<a class="before_after_year"
					href="calenar.do?year=${ today_info.search_year - 1 }&month=${ today_info.search_month - 1}">
					&lt;&lt;
				</a>
				<%-- 이전 달 --%>
				<a class="before_after_month"
					href="clendar.do?year=${ today_info.before }&month=${ today_info.before_month }">
					&lt;
				</a>
			...
			<div class="today_button_div">
				<button type="button" class="buttonstyle" onclick="javascript:location.href='calendar.do'"
						style="height: 3-0px; width: 80px;">Today
				</button>
				<button type="button" class="buttonstyle board_move openMask_boardmove pointer"
						style="height: 30px; width:130px;">Add Schedule
				</button>
			</div>
			...
			<table class="calendar_body">
				<thead>
					<tr bgcolor="#A0D9E2">
						<td calss="day sun">Sun</td>
						<td calss="day">Mon</td>
						<td calss="day">Tue</td>
						<td calss="day">Web</td>
						<td calss="day">Thu</td>
						<td calss="day">Fri</td>
						<td calss="day sat">Sat</td>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<div>
							...
							<c:forEach var="scheduleList" items="${ dateList.schedule_data_arr }" 
										varStatus="schedule_data_arr_status">
										
								<!-- <a href="/schedule_sho?schedule_idx=${ scheduleList.schedule_idx }" 
										onclick="window.open(this.href, '_blank', 'width=550,height=600,left=680%,top=200%, toolbars=no,scrollbars=no'); return false;"
										class="date_subject" style="color:${ scheduleList.schedule_mycolor }">${ scheduleList.schedule_subject }
								</a>
								 -->
								<br>
							</c:forEach>
	...
	<div class="nomal_move_board_modal">
		<script type="text/javascript">
			$(function(){
				$("#testDatepicker")
					.datepicker(
		...
		<div class="bottom">
			...
			<form name="schedule_add" action="schedule_add.do">
				...
				<input typ="hidden" name="year" value="${ today_info.search_year }" />
				<input typ="hidden" name="month" value="${ today_info.search_month - 1 }" />
					...
					<ul>
						...
						<li>
							...
							<div class="text_desc">
								...
								<input type="text" name="schedule_date" class="text_type1" id="testDatepicker" 
								readonly="readonly" />
						...
						<li style="margin-botton: 70px;">
							<div class="text_subject">내용 : </div>
							<div class="text_desc">
								<textarea name="schedule_num" class="text_type1" rows="5"></textarea>
								
							</div>
						</li>
						<li>
							<div class="text_subject">공유 : </div>
								<input class="radio" type="radio" name="schedule_share" value="1" cheched="checked" />공개
...
<!-- 						</li> -->
						...
						<li class="button_li">
							<button  type="button" class="buttonstyle board_move_go pointer" name="schedule_num" class="text_type1" 
