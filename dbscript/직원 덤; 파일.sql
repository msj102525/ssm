...
DELETE FROM tb_employee_1;

INSERT INTO TB_EMPLOYEE_1 (EMP_ID, EMP_NAME, POSITION, EMP_HIREDATE, EMP_PHONE, EMP_EMAIL, EMP_ADDRESS, EMP_BIRTHDATE, EMP_GENDER)
...
DELETE FROM TB_COMMUTE_INFO_1;

INSERT INTO TB_COMMUTE_INFO_1 (EMP_ID, START_TIME, WORK_DAY, END_TIME, WORKING_HOURS, LATE_FLAG, LEAVE_EARLY, ABSENTEEISM)
...
DELETE FROM TB_SALARY_INFO_1;

INSERT INTO TB_SALARY_INFO_1 (EMP_ID, BANK_NAME, BANK_ACCOUNT_NO, ACCOUNT_HOLDER, PREMIUM, TAX)
